        ...
        relaxion: {
            ...
            cards: [
                ...
                },
                {
                    ...
                    description:
                        "Protecting your skin from the sun's harmful rays is crucial for reducing the risk of skin cancer and premature aging. Experts recommend using a broad-spectrum sunscreen.",
                },
            ],
        },
        rest: {
...
router.get('/shoporder', function (req, res) {
    res.render('shoporder', {
        ...
        quiz: {
            ...
            preference: {
                title:
                    'Який тип обладнання ви зацікавлені в придбати?',
                options: [
                    'Смартфони',
                    'Ноутбуки',
                    'Планшети',
